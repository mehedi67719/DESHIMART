        ...
        return (
            <div className='container mx-auto px-4 mb-16'>
                <div className='text-center mb-12'>
                    <div className='h-12 bg-gradient-to-r from-gray-200 to-gray-300 w-64 mx-auto mb-4 rounded animate-pulse'></div>
                    <div className='h-6 bg-gradient-to-r from-gray-200 to-gray-300 w-96 mx-auto rounded animate-pulse'></div>
                </div>
                ...
                <div className='bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden'>
                        ...
                        <div className='flex flex-col md:flex-row gap-6 items-center justify-between'>
                            <div className='relative w-full'>
                                <div className='flex items-center gap-3 bg-white p-3 rounded-2xl shadow-sm border border-gray-100'>
                                    <div className='h-10 bg-gradient-to-r from-gray-200 to-gray-300 w-48 rounded-xl animate-pulse'></div>
                                    <div className='h-6 bg-gradient-to-r from-gray-200 to-gray-300 w-96 rounded animate-pulse'></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='flex items-center px-4 justify-between my-6'>
                            <div>
                                <div className='h-8 bg-gradient-to-r from-gray-200 to-gray-300 w-48 mb-2 rounded animate-pulse'></div>
                                <div className='h-5 bg-gradient-to-r from-gray-200 to-gray-300 w-64 rounded animate-pulse'></div>
                            </div>
                        </div>
                        ...
                        <div className='border-t border-gray-200'>
                            <div className='pt-10 grid px-4 grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-5'>
                                {Array(10).fill("").map((_, idx) => (
                                    <div key={idx} className="animate-pulse border border-gray-200 rounded-2xl overflow-hidden">
