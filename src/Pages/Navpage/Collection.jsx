        ...
        return (
            <div className='container mx-auto px-4 mb-16'>
                <div className='text-center mb-12'>
                    <div className='h-12 bg-gradient-to-r from-gray-200 to-gray-300 w-96 mx-auto mb-4 rounded animate-pulse'></div>
                    ...
                    <div className='px-4 py-6'>
                        <div className='flex flex-col md:flex-row gap-6 items-center justify-between'>
                            <div className='relative w-full md:w-2/3'>
                                <div className='h-14 bg-gradient-to-r from-gray-200 to-gray-300 w-full rounded-2xl animate-pulse'></div>
                            </div>
                            <div className='flex items-center gap-3 bg-gray-50 p-2 rounded-2xl'>
                                <div className='h-12 w-20 bg-gradient-to-r from-gray-200 to-gray-300 rounded-xl animate-pulse'></div>
                                <div className='h-12 w-20 bg-gradient-to-r from-gray-200 to-gray-300 rounded-xl animate-pulse'></div>
                                <div className='h-12 w-20 bg-gradient-to-r from-gray-200 to-gray-300 rounded-xl animate-pulse'></div>
                            </div>
                        </div>
